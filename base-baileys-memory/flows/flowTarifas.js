...
import {CANUELAS_PATH_NO_AVAILABILITY, SAN_MIGUEL_PATH_NO_AVAILABILITY} from "../constants/images_path.js";
...
export const flowTarifas = addKeyword(['1'])
    ...
    .addAnswer(' ', { media: SAN_MIGUEL_PATH_NO_AVAILABILITY})
    .addAnswer(' ', { media: CANUELAS_PATH_NO_AVAILABILITY})
